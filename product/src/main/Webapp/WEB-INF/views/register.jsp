...
<form action="/users" method="post">
 ...
 <label for="name"><b>Id</b></label>
    ...
    <input type="text" placeholder="Enter fisrtname" name="fisrtname" id="fisrtname" ><br><br>
    ...
    <input type="text" placeholder="Enter emailId" name="emailId" id="emailId" ><br><br>

    <label for="year"><b>mobileNumber</b></label>
    <input type="text" placeholder="Enter mobileNumber" name="mobileNumber" id="mobileNumber" ><br><br>
